...
namespace firstchain
{
    public partial class Program
    {
        ...
        public static uint TARGET_TIME = 2520; // 1209600 . number of seconds a block should be mined 10 *  ---> WE SHOULD GET ONE BLOCK EVERY 10S . this is working !!! 
        ...
        public static float SEA_MAXLEVEL = 7f;
        public static float SEA_FORCE = 4f; //< change sea force as you need. 10 should be a strong impact! below 5f it is not suffisant i guess. 8f is ok!
        public static int ACTUAL_PORT = 37;
        public static ulong SEA_UINT256_PRECISION = 1000000000000000000;
