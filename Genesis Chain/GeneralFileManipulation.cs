...
namespace firstchain
{
    public partial class Program
    {
        ...
        public static bool SECURE_MODE = true;
        ...
        public static void CheckFilesAtRoot() // check if file are in folder to process
        {
            ...
            if ( !File.Exists(_folderPath + "tidaloracle"))
            {
                Console.WriteLine("will create tidaloracle file...");
                 if (!Tidal.GetTidalPrevision()) { Console.ReadKey(); Environment.Exit(0);  return; }
            }
            else
            {
            ...
            if (!Tidal.SetLatestRequest()) { Console.ReadKey(); Environment.Exit(0); return; };
