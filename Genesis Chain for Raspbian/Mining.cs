...
namespace firstchain
{
    public partial class Program
    {
        ...
        public static string MineBlock(List<Tx> TXS, Block prevBlock, byte[] pKey, uint mUTXOP, string WinBlockPath)
        {
            ...
            List<SHOM.SHOMData> shoms = SHOM.GetShomDatafromPeriod(ACTUAL_PORT, unixTimestamp, unixTimestamp);
            ...
            while (true)
            {
                ...
                if (isNonceGolden(hash, HASH_TARGET))
                {
                    ...
                    {
                        Console.WriteLine("will write a new file at " + WinBlockPath);
        ...
        public static bool isNonceGolden(byte[] hash, byte[] hashtarget)
        {
            ...
            {
                Console.WriteLine(myHash + " was lower than " + target);
                return true;
            }
            else
            {
